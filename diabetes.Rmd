...
$log\frac{\pi}{1-\pi}=-5.09+0.40I\{Male\}+0.03X_{age}+0.98I\{Overweight\}-0.26I\{Hypertension\}-0.02X_{Steeth}+0.61X_{Mpdcat}+0.20I\{Smoke\}$

where $log\frac{\pi}{1-\pi}$ is the log odds of diabetes